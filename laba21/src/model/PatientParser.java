...
public class PatientParser {
    public void parseAndWrite(String rootTag, String nodeTag, ArrayList<Patient> parsedModelArray, String writePath) {
        ...
        try {
            ...
            for (Patient currentEntry : parsedModelArray) {
                ...
                rootElement.appendChild(getEntry(writtenDocument, nodeTag, fullName,  birthDate, appointmentDate, doctorName, conclusion));
            }
    ...
    private Node getEntry(Document writtenDocument, String nodeTag, String fullName,  String birthDate,
